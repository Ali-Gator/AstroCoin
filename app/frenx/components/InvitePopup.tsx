  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-between overflow-scroll">
      <div className="flex flex-col items-center">
        <p className="text-[32px] font-termina600">Invite frenx</p>
      ...
      <Link
        className="rounded-[14px] w-full uppercase text-black bg-white mt-2 p-4 text-xl font-termina600 text-center"
